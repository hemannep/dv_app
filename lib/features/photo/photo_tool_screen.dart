// lib/screens/photo_tool_screen.dart
...
class _PhotoToolScreenState extends State<PhotoToolScreen>
  ...
  void _toggleMode() {
    setState(() {
      ...
      _currentTipIndex = 0; // Reset tip index
    });
    _saveModePreference();
          ...
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [theme.primaryColor, theme.primaryColor.withOpacity(0)],
              ),
            ),
          ),
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      _isBabyMode ? 'Baby Mode' : 'Adult Mode',
                                      style: const TextStyle(
                                        fontSize: 20,
                                        fontWeight: FontWeight.bold,
                                      ),
